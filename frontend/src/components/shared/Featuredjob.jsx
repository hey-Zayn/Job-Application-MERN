    ...
    <div className="w-full px-20 py-[100px]">
      ...
      <div className="grid lg:grid-cols-3 max-md:grid-cols-1 gap-4 mt-[50px]">
        {jobslist?.map((i) => (
          <div
            key={i}
            className="w-[424] h-[170px] max-sm:h-full p-[24px] max-sm:w-full  flex flex-col gap-2  group rounded-xl border border-gray-200 "
            style={{
              background: i.active
          ...
          >
            <div className="space-y-2">
              <h1 className="text-xl cursor-pointer">{i.title}</h1>
              <div className="flex gap-3 space-y-2">
                <h4 className="bg-green-600/20 text-xs text-green-700 px-2 py-1 rounded-full">
                  <span className="text-[11px] uppercase">{i.type}</span>
                </h4>
                <h3 className="text-[12px] text-black/50">
            ...
            <div className="space-y-2 text-start">
              <div className="flex items-center justify-between gap-2">
                <div className="flex gap-2">
                  <img src={EmployersLogo} alt="company Logo" className="cursor-pointer"/>
