...
import { ArrowRight, Bookmark, BookMarked, LoaderIcon, Locate, MapPin, MoreVertical } from "lucide-react";
...
const Browse = () => {
  return (
    <div className="w-full px-20 max-sm:px-6 py-[100px]">
        ...
        {/* <h1 className="text-3xl font-semibold mb-10">Browse Companies</h1> */}
      
      

      <div className="grid lg:grid-cols-3 max-md:grid-cols-1  gap-4 ">
        {jobslist?.map((i) => (
          <div
            key={i}
      ...
      <div className="mt-10 w-full flex   justify-center items-center">
        ...
        <button className="text-white px-4 py-2 rounded-lg bg-blue-600 text-md flex items-center gap-1 cursor-pointer">
          Load More
        </button>
      </div>
    </div>
