...
import Vacancies from "../components/shared/Vacancies";
import HowJobpilotwork from "../components/shared/HowJobpilotwork";
        ...
        <div className="w-full min-h-[60vh] flex flex-col lg:flex-row justify-center items-center px-4  sm:px-6 lg:px-8 py-12 lg:pt-20 overflow-hidden">
          <div className="w-full lg:w-1/2 space-y-6 lg:space-y-8 max-w-2xl lg:pr-10">
            ...
            <div className="flex flex-wrap gap-3 pt-4">
              ...
              {["Developer", "Designer", "Remote"].map((tag) => (
                <span
                  key={tag}
                  className="text-sm text-black/50 cursor-pointer hover:text-blue-600"
                >
                  {tag},
                </span>
              ))}
